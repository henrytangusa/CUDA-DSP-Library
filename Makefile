...
cudaSaSLTest: cudaSaSL.o cudaSignals.o cudaSystems.o cudaClient.o cudaSignals_kernels.o
...
clean:
	rm -f cudaSaSLTest cudaSaSL.o cudaSignals.o cudaSystems.o cudaClient.o
